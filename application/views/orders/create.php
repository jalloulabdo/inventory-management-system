          ...
          <form role="form" action="<?php base_url('Controller_Orders/create') ?>" method="post"
            ...
            <div class="box-body">
              ...
              <div class="col-md-7 col-xs-12 pull pull-left">
                ...
                <div class="form-group">
                  <label for="gross_amount" class="col-sm-5 control-label" style="text-align:left;">Clients</label>
                  <div class="col-sm-7">
                    <select class="form-control select_group product" data-row-id="row_1" id="customer"
                      name="customer_id" style="width:100%;" onchange="getProductData(1)" required>
                      <option value=""></option>
                ...
                <!-- <div class="form-group">
                  <label for="gross_amount" class="col-sm-5 control-label" style="text-align:left;">Client
                    Address</label>
                  <div class="col-sm-7">
                    <textarea type="text" class="form-control" id="customer_address" name="customer_address"
                      placeholder="Enter Client Address" autocomplete="off"></textarea>
                  </div>
                </div> -->
              ...
              <table class="table table-bordered" id="product_info_table">
                ...
                <tbody>
                  <tr id="row_1">
                    ...
                    <td><input type="number" name="qty[]" id="qty_1" class="form-control" required onkeyup="getTotal(1)">
                    </td>
                    <td>
                    ...
                    <td><button type="button" class="btn btn-danger btn-sm" onclick="removeRow('1')"><i

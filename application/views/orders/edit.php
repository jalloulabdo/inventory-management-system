    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        ...
        <div class="box">
          ...
          <!-- /.box-header -->
          <form role="form" action="<?php base_url('Controller_Orders/create') ?>" method="post"
            ...
            <div class="box-body">
              ...
              <div class="col-md-7 col-xs-12 pull pull-left">
                ...
                <div class="form-group">
                  <label for="gross_amount" class="col-sm-5 control-label" style="text-align:left;">Client</label>
                  <div class="col-sm-7">
                    <select class="form-control select_group product" id="customer_id" name="customer_id"
                      style="width:100%;" required>
                      <option value=""></option>
                      <?php foreach ($clients as $k => $v): ?>
                        <option value="<?php echo $v['id'] ?>" <?php if ($order_data['order']['customer_id'] == $v['id']) {
                             echo "selected='selected'";
                           } ?>><?php echo $v['firstname'] ?>   <?php echo $v['lastname'] ?>
                        </option>
                      <?php endforeach ?>
                    </select>
                  </div>
              ...
              <table class="table table-bordered" id="product_info_table">
                <thead>
                  <tr>
                    ...
                    <th style="width:10%"><button type="button" id="add_row" class="btn btn-primary btn-sm"><i
                  ...
                  <?php if (isset($order_data['order_item'])): ?>
                    ...
                    <?php foreach ($order_data['order_item'] as $key => $val): ?>
                      ...
                      <tr id="row_<?php echo $x; ?>">
                        ...
                        <td><button type="button" class="btn btn-danger btn-sm" onclick="removeRow('<?php echo $x; ?>')"><i
              ...
              <div class="col-md-6 col-xs-12 pull pull-left">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-7">
                    <input type="text" class="form-control" id="discount" name="discount" placeholder="Discount"
                      onkeyup="subAmount()" value="<?php echo $order_data['order']['discount'] ?>" autocomplete="off">
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-7">
                    <select type="text" class="form-control" id="paid_status" name="paid_status">
                      <option value="1" <?php if ($order_data['order']['paid_status'] == 1) {
                        echo "selected='selected'";
                      } ?>>Paid</option>
                      <option value="2" <?php if ($order_data['order']['paid_status'] == 2) {
                        echo "selected='selected'";
                      } ?>>Unpaid</option>
                    </select>
                  </div>
                ...
                <div class="form-group" id="payment_type">
                  <label for="type_payment" class="col-sm-5 control-label">Payment Type</label>
                  <div class="col-sm-7">
                    <select type="text" class="form-control" id="type_payment" name="type_payment">
                      <option value=""></option>
                      <option value="CHQ" <?php if(isset($order_data['order']['type_payment']) && $order_data['order']['type_payment'] == 'CHQ') echo 'selected="selected"'; ?>>CHQ</option>
                      <option value="espece" <?php if(isset($order_data['order']['type_payment']) && $order_data['order']['type_payment'] == 'espece') echo 'selected="selected"'; ?>>Espece</option>
                    </select>
                  </div>
                </div>
              </div>
            ...
            <div class="box-footer">
              ...
              <a target="__blank"
                href="<?php echo base_url() . 'Controller_Orders/printDiv/' . $order_data['order']['id'] ?>"
                class="btn bg-blue">Print</a>
...
<script type="text/javascript">
  ...
  $(document).ready(function () {
    ...
    // Initially hide the payment type dropdown
    $('#payment_type').hide();
     // Check if type_payment exists in order_data
    var typePaymentExists = "<?php echo isset($order_data['order']['type_payment']); ?>";
    if (typePaymentExists) {
        $('#payment_type').show(); // Show the payment type dropdown if type_payment exists
    }
    // Event listener for change in paid status dropdown
    $('#paid_status').change(function () {
      var paidStatusValue = $(this).val();
      if (paidStatusValue == 1) {
        // If paid status is 1, show the payment type dropdown
        $('#payment_type').show();
      } else {
        // Otherwise, hide the payment type dropdown
        $('#payment_type').hide();
      }
    });
  }); // /document

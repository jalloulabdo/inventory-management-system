            ...
            <li class="treeview" id="mainClientNav">
              ...
              <ul class="treeview-menu">
                <?php if(in_array('createClient', $user_permission)): ?>
                  <li id="addClientNav"><a href="<?php echo base_url('Controller_Client/create') ?>"><i class="fa fa-circle-o"></i> Add Client</a></li>
                <?php endif; ?>
                <?php if(in_array('updateClient', $user_permission) || in_array('viewClient', $user_permission) || in_array('deleteClient', $user_permission)): ?>
                <li id="manageClientNav"><a href="<?php echo base_url('Controller_Client') ?>"><i class="fa fa-circle-o"></i> Manage Clients</a></li>
                <?php endif; ?>
              </ul>
            </li>
          <?php endif; ?>

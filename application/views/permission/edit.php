                ...
                <div class="form-group">
                  ...
                  <table class="table table-responsive">
                    ...
                    <tr>
                        ...
                        <td><input type="checkbox" name="permission[]" id="permission" class="minimal" value="updateClient" <?php 
                        if($serialize_permission) {
                          if(in_array('updateClient', $serialize_permission)) { echo "checked"; } 
                        }
                        ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" class="minimal" value="viewClient" <?php 
                        if($serialize_permission) {
                          if(in_array('viewClient', $serialize_permission)) { echo "checked"; }   
                        }
                        ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" class="minimal" value="deleteClient" <?php 
                        if($serialize_permission) {

        ...
        <form role="form" action="<?php echo base_url('Controller_Items/create') ?>" method="post" id="createBrandForm">
          ...
          <div class="modal-body">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="brand_name" name="brand_name" placeholder="Enter item name"
                autocomplete="off">
            </div>
            <div class="form-group">
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-danger closse" data-dismiss="modal">Close</button>
